...
namespace Bolt.Samples
{
	public class BoltInit : Bolt.GlobalEventListener
	{
		...
		{
            var tex_height = 300;
			Rect tex = new Rect(10, 10, Screen.width - 20, tex_height);
			Rect area = new Rect(10, tex_height + 15, Screen.width - 20, Screen.height - (tex_height + 25));

			GUI.Box(tex, Resources.Load("Title Screen") as Texture2D);
